(function() {
	...
	function drawpoints(){
		...
		for(let i=0;i<lines.length;i++){
			...
			ctx.moveTo(line.sx-1000*Math.cos(line.r+Math.PI/3),line.sy-1000*Math.sin(line.r+Math.PI/3));
			ctx.lineTo(line.sx+1000*Math.cos(line.r+Math.PI/3),line.sy+1000*Math.sin(line.r+Math.PI/3));
			ctx.moveTo(line.sx-1000*Math.cos(line.r+Math.PI/3*2),line.sy-1000*Math.sin(line.r+Math.PI/3*2));
			ctx.lineTo(line.sx+1000*Math.cos(line.r+Math.PI/3*2),line.sy+1000*Math.sin(line.r+Math.PI/3*2));
