        ...
        if (sroll.life <= 0) {
            if(sroll.life2==2){
                srolls.push({
                    sx: sroll.sx,
                    sy: sroll.sy,
                   vx: (mx- sroll.sx)/50, //x轴及y轴的移动向量，取值范围为-0.5 ~ 0.5
                    vy: (my- sroll.sy)/50,
...
//                    vy: (my-sroll.sy)/200,
    ...
    cnt++;
        srolls.push({
                    sx: rx,
                    sy: ry,
                    vx: Math.sin(tt*Math.PI*2/360), //x轴及y轴的移动向量，取值范围为-0.5 ~ 0.5
    ...
    srolls.push({
                    sx: rx,
                    sy: ry,
                    vx: Math.sin(tt*Math.PI*2/360+Math.PI), //x轴及y轴的移动向量，取值范围为-0.5 ~ 0.5
                    vy: Math.cos(tt*Math.PI*2/360+Math.PI),
                    life: live,
                    life2:2,
                    color:colors[parseInt(Math.random() * colors.length)],
                    size:10
